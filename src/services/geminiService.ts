...
//     `;
//     // const response = await ai.models.generateContent
//     const check1 = await ai.models.generateContent({model:'gemini-2.0-flash', contents: [prompt,imagePart]});
//     // const result = await model.generateContent([prompt, imagePart]);
//     // const response = await result.response;
//     // const text = response.text();
//     console.log("image part ", imageFile);
//     const text = check1.text;
//     console.log('Gemini response:', check1.text);
//     //
